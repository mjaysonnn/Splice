...
# CONFIGURATION
USE_CASE_FOR_EXPERIMENT = "SPLICE"  # TODO : Change This
...
class ModuleConfigClass:
    ...
    result_logfile_name: str = "../Log/Result/splice_result.log"
...
def empty_result_log():
    """Empty splice_result.log
    :return: None
    """
    logger.info("Empty splice_result.log beforehand")
...
def determine_num_of_excess_servers(num_of_requests, num_of_vm, arrival_rate, duration):
    ...
    if USE_CASE_FOR_EXPERIMENT == "SPLICE":
        """
...
def copy_result_log():
    ...
    src_file = os.path.join(log_folder, "splice_result.log")
    try:
        if RESULT_LOG_NAME:
            log_to_copy = (
                f"{log_folder}/"
